...
class BrongnalClient extends $grpc.Client {
  static final _$registerPreKeyBundle = $grpc.ClientMethod<
          $0.RegisterPreKeyBundleRequest, $0.RegisterPreKeyBundleResponse>(
      '/service.Brongnal/RegisterPreKeyBundle',
      ($0.RegisterPreKeyBundleRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.RegisterPreKeyBundleResponse.fromBuffer(value));
  static final _$requestPreKeys =
      $grpc.ClientMethod<$0.RequestPreKeysRequest, $0.PreKeyBundle>(
  ...
  static final _$retrieveMessages = $grpc.ClientMethod<
          $0.RetrieveMessagesRequest, $0.RetrieveMessagesResponse>(
      '/service.Brongnal/RetrieveMessages',
      ($0.RetrieveMessagesRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.RetrieveMessagesResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.RegisterPreKeyBundleResponse> registerPreKeyBundle(
      $0.RegisterPreKeyBundleRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$registerPreKeyBundle, request, options: options);
  }

  $grpc.ResponseFuture<$0.PreKeyBundle> requestPreKeys(
      $0.RequestPreKeysRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.RetrieveMessagesResponse> retrieveMessages(
      $0.RetrieveMessagesRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class BrongnalServiceBase extends $grpc.Service {
  ...
  BrongnalServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.RegisterPreKeyBundleRequest,
            $0.RegisterPreKeyBundleResponse>(
        'RegisterPreKeyBundle',
        registerPreKeyBundle_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.RegisterPreKeyBundleRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.RequestPreKeysRequest, $0.PreKeyBundle>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.RequestPreKeysRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.RetrieveMessagesRequest,
            $0.RetrieveMessagesResponse>(
        'RetrieveMessages',
        retrieveMessages_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.RetrieveMessagesRequest.fromBuffer(value),
        ($0.RetrieveMessagesResponse value) => value.writeToBuffer()));
  }

  $async.Future<$0.RegisterPreKeyBundleResponse> registerPreKeyBundle_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.RegisterPreKeyBundleRequest> request) async {
    return registerPreKeyBundle(call, await request);
  }

  $async.Future<$0.PreKeyBundle> requestPreKeys_Pre($grpc.ServiceCall call,
      $async.Future<$0.RequestPreKeysRequest> request) async {
  ...
  $async.Future<$0.RetrieveMessagesResponse> retrieveMessages_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.RetrieveMessagesRequest> request) async {
    return retrieveMessages(call, await request);
  }

  $async.Future<$0.RegisterPreKeyBundleResponse> registerPreKeyBundle(
      $grpc.ServiceCall call, $0.RegisterPreKeyBundleRequest request);
  $async.Future<$0.PreKeyBundle> requestPreKeys(
      $grpc.ServiceCall call, $0.RequestPreKeysRequest request);
  $async.Future<$0.SendMessageResponse> sendMessage(
      $grpc.ServiceCall call, $0.SendMessageRequest request);
  $async.Future<$0.RetrieveMessagesResponse> retrieveMessages(
      $grpc.ServiceCall call, $0.RetrieveMessagesRequest request);
}
